                ...
                <div class="block">
                  <div class="portfolio-menu">
                    <ul>
                        ...
                        <li class="Bilgisayar Parçaları-li"
                        <li class="filter" data-filter=".Branding">Bilgisayar Parçaları</li>
                        <div id="Bilgisayar Parçaları-content">
                              <ul>
                                 <li <a href="#">İşlemci</a></li>
                                 <li <a href="#">Anakart</a></li>
                                 <li <a href="#">Harddisk</a></li>
                                 <li <a href="#">Bellek</a></li>
                                 <li <a href="#">Kasa PSU</a></li>
                                 <li <a href="#">Ekran Kartı</a></li>
                                 <li <a href="#">Optik Sürücü</a></li>
                                 <li <a href="#">Klavye Mouse</a></li>
                                 <li <a href="#">Hoperlör</a></li>
                                 <li <a href="#">Monitör</a></li>
                                 <li <a href="#">Web Kamera<a/></li>
                                 <li <a href="#">Kulaklık</a></li>
                                 <li <a href="#">Termal Macun</a></li>
                                 <li <a href="#">Sıvı Soğutma</a></li>
                                </ul>
                        <li class="filter" data-filter=".Graphic">Masaüstü Bilgisayar</li>
                        <li class="filter" data-filter=".design">Baskı Çözümleri</li>
                        <li class="filter" data-filter=".Video">Ağ Ürünleri</li>
                        <li class="filter" data-filter=".Video">Güvenlik Ürünleri</li>
                        <li class="filter" data-filter=".Ürün">Tüketim Malzemeleri</li>
                        <li class="filter" data-filter=".Şerit">Barkod Ürünleri</li>
                        <li class="filter" data-filter=".Sunucu">Kurumsal Ürünler</li>
                        <li class="filter" data-filter=".Power">Kesintisiz Güç Kaynağı</li>
                        <li class="filter" data-filter=".Bank">Tüketici Elektroniği</li>
                         <li class="filter" data-filter=".HDMI">Kablo Dönüştürücüler</li>
                        <li class="filter" data-filter=".Tel">Telefon</li>
                        <li class="filter" data-filter=".Cihaz">Projeksiyon</li>
                        <li class="filter" data-filter=".Lisans">Yazılım</li>
                    </ul>
                  </div>
                  <div class="portfolio-contant">
                    <ul id="portfolio-contant-active">
                        <li class="mix Bilgisayar Parçaları">
                      <a href="#">
